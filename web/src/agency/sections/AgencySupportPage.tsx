...
const FAQS = [
  { q: 'How do I create a sub-agent?', a: 'Go to Agent Management → + Create Agent. A temporary password is generated and shown once.' },
  { q: 'How is my available credit calculated?', a: 'Available credit = your credit limit minus outstanding (unpaid credit invoices). It updates as invoices are settled.' },
  { q: 'What is a day-use booking?', a: 'A same-day stay with no overnight. Toggle "Day use" on the Search & Book page to see day-use rates.' },
  { q: 'How do I pay an outstanding invoice?', a: 'Open Payments & Credit, find the invoice and choose Settle — you can pay in full or in part.' },
  { q: 'Why was my booking not confirmed instantly?', a: 'Prepay bookings are held until payment; over-limit credit bookings await payment too. Once paid, they confirm automatically.' },
];
